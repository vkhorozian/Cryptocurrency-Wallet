...
def send_transaction(w3, account, to, wage):
    ...
    # Estimate a gas price. For instance, you can use web3.eth.gasPrice for an approximation.
    gas_price = w3.eth.gasPrice

    # You might also want to specify a gas limit. A simple hardcoded value would be something like 100000
    gas_limit = 100000 

    # Calculation nonce
    nonce = w3.eth.getTransactionCount(account.address)

    # Construct a raw transaction who will have gasPrice and gas included
    raw_tx = {
        "to": to,
